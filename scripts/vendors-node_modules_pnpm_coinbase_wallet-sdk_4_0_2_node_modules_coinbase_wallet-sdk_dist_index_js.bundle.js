 ...
 */
(self["webpackChunkart_interface_v1"] = self["webpackChunkart_interface_v1"] || []).push([["vendors-node_modules_pnpm_coinbase_wallet-sdk_4_0_2_node_modules_coinbase_wallet-sdk_dist_index_js"],{

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletProvider.js":
/*!************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletProvider.js ***!
  \************************************************************************************************************************/
...
"use strict";
eval("\n// Copyright (c) 2018-2024 Coinbase, Inc. <https://www.coinbase.com/>\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.CoinbaseWalletSDK = void 0;\nconst wallet_logo_1 = __webpack_require__(/*! ./assets/wallet-logo */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/assets/wallet-logo.js\");\nconst CoinbaseWalletProvider_1 = __webpack_require__(/*! ./CoinbaseWalletProvider */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletProvider.js\");\nconst ScopedLocalStorage_1 = __webpack_require__(/*! ./util/ScopedLocalStorage */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/util/ScopedLocalStorage.js\");\nconst version_1 = __webpack_require__(/*! ./version */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/version.js\");\nconst util_1 = __webpack_require__(/*! ./core/type/util */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/type/util.js\");\nconst provider_1 = __webpack_require__(/*! ./util/provider */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/util/provider.js\");\nclass CoinbaseWalletSDK {\n    constructor(metadata) {\n        this.metadata = {\n            appName: metadata.appName || 'Dapp',\n            appLogoUrl: metadata.appLogoUrl || (0, util_1.getFavicon)(),\n            appChainIds: metadata.appChainIds || [],\n        };\n        this.storeLatestVersion();\n    }\n    makeWeb3Provider(preference = { options: 'all' }) {\n        var _a;\n        const params = { metadata: this.metadata, preference };\n        return (_a = (0, provider_1.getCoinbaseInjectedProvider)(params)) !== null && _a !== void 0 ? _a : new CoinbaseWalletProvider_1.CoinbaseWalletProvider(params);\n    }\n    /**\n     * Official Coinbase Wallet logo for developers to use on their frontend\n     * @param type Type of wallet logo: \"standard\" | \"circle\" | \"text\" | \"textWithLogo\" | \"textLight\" | \"textWithLogoLight\"\n     * @param width Width of the logo (Optional)\n     * @returns SVG Data URI\n     */\n    getCoinbaseWalletLogo(type, width = 240) {\n        return (0, wallet_logo_1.walletLogo)(type, width);\n    }\n    storeLatestVersion() {\n        const versionStorage = new ScopedLocalStorage_1.ScopedLocalStorage('CBWSDK');\n        versionStorage.setItem('VERSION', version_1.LIB_VERSION);\n    }\n}\nexports.CoinbaseWalletSDK = CoinbaseWalletSDK;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletSDK.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/assets/wallet-logo.js":
/*!********************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/assets/wallet-logo.js ***!
  \********************************************************************************************************************/
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.Communicator = void 0;\nconst version_1 = __webpack_require__(/*! ../../version */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/version.js\");\nconst util_1 = __webpack_require__(/*! ./util */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/communicator/util.js\");\nconst constants_1 = __webpack_require__(/*! ../constants */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/constants.js\");\nconst error_1 = __webpack_require__(/*! ../error */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/index.js\");\n/**\n * Communicates with a popup window for Coinbase keys.coinbase.com (or another url)\n * to send and receive messages.\n *\n * This class is responsible for opening a popup window, posting messages to it,\n * and listening for responses.\n *\n * It also handles cleanup of event listeners and the popup window itself when necessary.\n */\nclass Communicator {\n    constructor(url = constants_1.CB_KEYS_URL) {\n        this.popup = null;\n        this.listeners = new Map();\n        /**\n         * Posts a message to the popup window\n         */\n        this.postMessage = async (message) => {\n            const popup = await this.waitForPopupLoaded();\n            popup.postMessage(message, this.url.origin);\n        };\n        /**\n         * Posts a request to the popup window and waits for a response\n         */\n        this.postRequestAndWaitForResponse = async (request) => {\n            const responsePromise = this.onMessage(({ requestId }) => requestId === request.id);\n            this.postMessage(request);\n            return await responsePromise;\n        };\n        /**\n         * Listens for messages from the popup window that match a given predicate.\n         */\n        this.onMessage = async (predicate) => {\n            return new Promise((resolve, reject) => {\n                const listener = (event) => {\n                    if (event.origin !== this.url.origin)\n                        return; // origin validation\n                    const message = event.data;\n                    if (predicate(message)) {\n                        resolve(message);\n                        window.removeEventListener('message', listener);\n                        this.listeners.delete(listener);\n                    }\n                };\n                window.addEventListener('message', listener);\n                this.listeners.set(listener, { reject });\n            });\n        };\n        /**\n         * Closes the popup, rejects all requests and clears the listeners\n         */\n        this.disconnect = () => {\n            (0, util_1.closePopup)(this.popup);\n            this.popup = null;\n            this.listeners.forEach(({ reject }, listener) => {\n                reject(error_1.standardErrors.provider.userRejectedRequest('Request rejected'));\n                window.removeEventListener('message', listener);\n            });\n            this.listeners.clear();\n        };\n        /**\n         * Waits for the popup window to fully load and then sends a version message.\n         */\n        this.waitForPopupLoaded = async () => {\n            if (this.popup && !this.popup.closed)\n                return this.popup;\n            this.popup = (0, util_1.openPopup)(this.url);\n            this.onMessage(({ event }) => event === 'PopupUnload')\n                .then(this.disconnect)\n                .catch(() => { });\n            return this.onMessage(({ event }) => event === 'PopupLoaded')\n                .then((message) => {\n                this.postMessage({\n                    requestId: message.id,\n                    data: { version: version_1.LIB_VERSION },\n                });\n            })\n                .then(() => {\n                if (!this.popup)\n                    throw error_1.standardErrors.rpc.internal();\n                return this.popup;\n            });\n        };\n        this.url = new URL(url);\n    }\n}\nexports.Communicator = Communicator;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/communicator/Communicator.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/communicator/util.js":
/*!************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/communicator/util.js ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.CBW_MOBILE_DEEPLINK_URL = exports.WALLETLINK_URL = exports.CB_KEYS_URL = void 0;\nexports.CB_KEYS_URL = 'https://keys.coinbase.com/connect';\nexports.WALLETLINK_URL = 'https://www.walletlink.org';\nexports.CBW_MOBILE_DEEPLINK_URL = 'https://go.cb-w.com/walletlink';\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/constants.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/constants.js":
/*!**********************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/constants.js ***!
  \**********************************************************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.standardErrors = exports.standardErrorCodes = void 0;\nvar constants_1 = __webpack_require__(/*! ./constants */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/constants.js\");\nObject.defineProperty(exports, \"standardErrorCodes\", ({ enumerable: true, get: function () { return constants_1.standardErrorCodes; } }));\nvar errors_1 = __webpack_require__(/*! ./errors */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/errors.js\");\nObject.defineProperty(exports, \"standardErrors\", ({ enumerable: true, get: function () { return errors_1.standardErrors; } }));\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/index.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/serialize.js":
/*!**********************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/error/serialize.js ***!
  \**********************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.RegExpString = exports.IntNumber = exports.BigIntString = exports.AddressString = exports.HexString = exports.OpaqueType = void 0;\nfunction OpaqueType() {\n    return (value) => value;\n}\nexports.OpaqueType = OpaqueType;\nexports.HexString = OpaqueType();\nexports.AddressString = OpaqueType();\nexports.BigIntString = OpaqueType();\nfunction IntNumber(num) {\n    return Math.floor(num);\n}\nexports.IntNumber = IntNumber;\nexports.RegExpString = OpaqueType();\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/type/index.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/type/util.js":
/*!****************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/type/util.js ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.CoinbaseWalletSDK = void 0;\n// Copyright (c) 2018-2024 Coinbase, Inc. <https://www.coinbase.com/>\nconst CoinbaseWalletSDK_1 = __webpack_require__(/*! ./CoinbaseWalletSDK */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletSDK.js\");\nexports[\"default\"] = CoinbaseWalletSDK_1.CoinbaseWalletSDK;\nvar CoinbaseWalletSDK_2 = __webpack_require__(/*! ./CoinbaseWalletSDK */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletSDK.js\");\nObject.defineProperty(exports, \"CoinbaseWalletSDK\", ({ enumerable: true, get: function () { return CoinbaseWalletSDK_2.CoinbaseWalletSDK; } }));\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/index.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/scw/SCWKeyManager.js":
/*!************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/scw/SCWKeyManager.js ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.RelayEventManager = void 0;\nconst util_1 = __webpack_require__(/*! ../../../core/type/util */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/type/util.js\");\nclass RelayEventManager {\n    constructor() {\n        this._nextRequestId = 0;\n        this.callbacks = new Map();\n    }\n    makeRequestId() {\n        // max nextId == max int32 for compatibility with mobile\n        this._nextRequestId = (this._nextRequestId + 1) % 0x7fffffff;\n        const id = this._nextRequestId;\n        const idStr = (0, util_1.prepend0x)(id.toString(16));\n        // unlikely that this will ever be an issue, but just to be safe\n        const callback = this.callbacks.get(idStr);\n        if (callback) {\n            this.callbacks.delete(idStr);\n        }\n        return id;\n    }\n}\nexports.RelayEventManager = RelayEventManager;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/RelayEventManager.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/WalletLinkRelay.js":
/*!***************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/WalletLinkRelay.js ***!
  \***************************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.APP_VERSION_KEY = exports.LOCAL_STORAGE_ADDRESSES_KEY = exports.WALLET_USER_NAME_KEY = void 0;\nexports.WALLET_USER_NAME_KEY = 'walletUsername';\nexports.LOCAL_STORAGE_ADDRESSES_KEY = 'Addresses';\nexports.APP_VERSION_KEY = 'AppVersion';\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/constants.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/type/WalletLinkSession.js":
/*!**********************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/type/WalletLinkSession.js ***!
  \**********************************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\n// Copyright (c) 2018-2023 Coinbase, Inc. <https://www.coinbase.com/>\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.isErrorResponse = void 0;\nfunction isErrorResponse(response) {\n    return response.errorMessage !== undefined;\n}\nexports.isErrorResponse = isErrorResponse;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/type/Web3Response.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/WLMobileRelayUI.js":
/*!******************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/WLMobileRelayUI.js ***!
  \******************************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.WLMobileRelayUI = void 0;\nconst RedirectDialog_1 = __webpack_require__(/*! ./components/RedirectDialog/RedirectDialog */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog.js\");\nconst util_1 = __webpack_require__(/*! ./components/util */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/util.js\");\nconst constants_1 = __webpack_require__(/*! ../../../../core/constants */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/core/constants.js\");\nclass WLMobileRelayUI {\n    constructor() {\n        this.attached = false;\n        this.redirectDialog = new RedirectDialog_1.RedirectDialog();\n    }\n    attach() {\n        if (this.attached) {\n            throw new Error('Coinbase Wallet SDK UI is already attached');\n        }\n        this.redirectDialog.attach();\n        this.attached = true;\n    }\n    redirectToCoinbaseWallet(walletLinkUrl) {\n        const url = new URL(constants_1.CBW_MOBILE_DEEPLINK_URL);\n        url.searchParams.append('redirect_url', (0, util_1.getLocation)().href);\n        if (walletLinkUrl) {\n            url.searchParams.append('wl_url', walletLinkUrl);\n        }\n        const anchorTag = document.createElement('a');\n        anchorTag.target = 'cbw-opener';\n        anchorTag.href = url.href;\n        anchorTag.rel = 'noreferrer noopener';\n        anchorTag.click();\n    }\n    openCoinbaseWalletDeeplink(walletLinkUrl) {\n        this.redirectDialog.present({\n            title: 'Redirecting to Coinbase Wallet...',\n            buttonText: 'Open',\n            onButtonClick: () => {\n                this.redirectToCoinbaseWallet(walletLinkUrl);\n            },\n        });\n        setTimeout(() => {\n            this.redirectToCoinbaseWallet(walletLinkUrl);\n        }, 99);\n    }\n    showConnecting(_options) {\n        // it uses the return callback to clear the dialog\n        return () => {\n            this.redirectDialog.clear();\n        };\n    }\n}\nexports.WLMobileRelayUI = WLMobileRelayUI;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/WLMobileRelayUI.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/WalletLinkRelayUI.js":
/*!********************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/WalletLinkRelayUI.js ***!
  \********************************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.WalletLinkRelayUI = void 0;\nconst cssReset_1 = __webpack_require__(/*! ./components/cssReset/cssReset */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/cssReset/cssReset.js\");\nconst Snackbar_1 = __webpack_require__(/*! ./components/Snackbar/Snackbar */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/Snackbar/Snackbar.js\");\nclass WalletLinkRelayUI {\n    constructor() {\n        this.attached = false;\n        this.snackbar = new Snackbar_1.Snackbar();\n    }\n    attach() {\n        if (this.attached) {\n            throw new Error('Coinbase Wallet SDK UI is already attached');\n        }\n        const el = document.documentElement;\n        const container = document.createElement('div');\n        container.className = '-cbwsdk-css-reset';\n        el.appendChild(container);\n        this.snackbar.attach(container);\n        this.attached = true;\n        (0, cssReset_1.injectCssReset)();\n    }\n    showConnecting(options) {\n        let snackbarProps;\n        if (options.isUnlinkedErrorState) {\n            snackbarProps = {\n                autoExpand: true,\n                message: 'Connection lost',\n                menuItems: [\n                    {\n                        isRed: false,\n                        info: 'Reset connection',\n                        svgWidth: '10',\n                        svgHeight: '11',\n                        path: 'M5.00008 0.96875C6.73133 0.96875 8.23758 1.94375 9.00008 3.375L10.0001 2.375V5.5H9.53133H7.96883H6.87508L7.80633 4.56875C7.41258 3.3875 6.31258 2.53125 5.00008 2.53125C3.76258 2.53125 2.70633 3.2875 2.25633 4.36875L0.812576 3.76875C1.50008 2.125 3.11258 0.96875 5.00008 0.96875ZM2.19375 6.43125C2.5875 7.6125 3.6875 8.46875 5 8.46875C6.2375 8.46875 7.29375 7.7125 7.74375 6.63125L9.1875 7.23125C8.5 8.875 6.8875 10.0312 5 10.0312C3.26875 10.0312 1.7625 9.05625 1 7.625L0 8.625V5.5H0.46875H2.03125H3.125L2.19375 6.43125Z',\n                        defaultFillRule: 'evenodd',\n                        defaultClipRule: 'evenodd',\n                        onClick: options.onResetConnection,\n                    },\n                ],\n            };\n        }\n        else {\n            snackbarProps = {\n                message: 'Confirm on phone',\n                menuItems: [\n                    {\n                        isRed: true,\n                        info: 'Cancel transaction',\n                        svgWidth: '11',\n                        svgHeight: '11',\n                        path: 'M10.3711 1.52346L9.21775 0.370117L5.37109 4.21022L1.52444 0.370117L0.371094 1.52346L4.2112 5.37012L0.371094 9.21677L1.52444 10.3701L5.37109 6.53001L9.21775 10.3701L10.3711 9.21677L6.53099 5.37012L10.3711 1.52346Z',\n                        defaultFillRule: 'inherit',\n                        defaultClipRule: 'inherit',\n                        onClick: options.onCancel,\n                    },\n                    {\n                        isRed: false,\n                        info: 'Reset connection',\n                        svgWidth: '10',\n                        svgHeight: '11',\n                        path: 'M5.00008 0.96875C6.73133 0.96875 8.23758 1.94375 9.00008 3.375L10.0001 2.375V5.5H9.53133H7.96883H6.87508L7.80633 4.56875C7.41258 3.3875 6.31258 2.53125 5.00008 2.53125C3.76258 2.53125 2.70633 3.2875 2.25633 4.36875L0.812576 3.76875C1.50008 2.125 3.11258 0.96875 5.00008 0.96875ZM2.19375 6.43125C2.5875 7.6125 3.6875 8.46875 5 8.46875C6.2375 8.46875 7.29375 7.7125 7.74375 6.63125L9.1875 7.23125C8.5 8.875 6.8875 10.0312 5 10.0312C3.26875 10.0312 1.7625 9.05625 1 7.625L0 8.625V5.5H0.46875H2.03125H3.125L2.19375 6.43125Z',\n                        defaultFillRule: 'evenodd',\n                        defaultClipRule: 'evenodd',\n                        onClick: options.onResetConnection,\n                    },\n                ],\n            };\n        }\n        return this.snackbar.presentItem(snackbarProps);\n    }\n}\nexports.WalletLinkRelayUI = WalletLinkRelayUI;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/WalletLinkRelayUI.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog-css.js":
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog-css.js ***!
  \***********************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports[\"default\"] = (() => `.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-backdrop{position:fixed;top:0;left:0;right:0;bottom:0;transition:opacity .25s;background-color:rgba(10,11,13,.5)}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-backdrop-hidden{opacity:0}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-box{display:block;position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);padding:20px;border-radius:8px;background-color:#fff;color:#0a0b0d}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-box p{display:block;font-weight:400;font-size:14px;line-height:20px;padding-bottom:12px;color:#5b636e}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-box button{appearance:none;border:none;background:none;color:#0052ff;padding:0;text-decoration:none;display:block;font-weight:600;font-size:16px;line-height:24px}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-box.dark{background-color:#0a0b0d;color:#fff}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-box.dark button{color:#0052ff}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-box.light{background-color:#fff;color:#0a0b0d}.-cbwsdk-css-reset .-cbwsdk-redirect-dialog-box.light button{color:#0052ff}`)();\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog-css.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog.js":
/*!*******************************************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog.js ***!
  \*******************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.RedirectDialog = void 0;\nconst clsx_1 = __importDefault(__webpack_require__(/*! clsx */ \"./node_modules/.pnpm/clsx@1.2.1/node_modules/clsx/dist/clsx.m.js\"));\nconst preact_1 = __webpack_require__(/*! preact */ \"./node_modules/.pnpm/preact@10.22.0/node_modules/preact/dist/preact.module.js\");\nconst cssReset_1 = __webpack_require__(/*! ../cssReset/cssReset */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/cssReset/cssReset.js\");\nconst Snackbar_1 = __webpack_require__(/*! ../Snackbar/Snackbar */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/Snackbar/Snackbar.js\");\nconst util_1 = __webpack_require__(/*! ../util */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/util.js\");\nconst RedirectDialog_css_1 = __importDefault(__webpack_require__(/*! ./RedirectDialog-css */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog-css.js\"));\nclass RedirectDialog {\n    constructor() {\n        this.root = null;\n        this.darkMode = (0, util_1.isDarkMode)();\n    }\n    attach() {\n        const el = document.documentElement;\n        this.root = document.createElement('div');\n        this.root.className = '-cbwsdk-css-reset';\n        el.appendChild(this.root);\n        (0, cssReset_1.injectCssReset)();\n    }\n    present(props) {\n        this.render(props);\n    }\n    clear() {\n        this.render(null);\n    }\n    render(props) {\n        if (!this.root)\n            return;\n        (0, preact_1.render)(null, this.root);\n        if (!props)\n            return;\n        (0, preact_1.render)((0, preact_1.h)(RedirectDialogContent, Object.assign({}, props, { onDismiss: () => {\n                this.clear();\n            }, darkMode: this.darkMode })), this.root);\n    }\n}\nexports.RedirectDialog = RedirectDialog;\nconst RedirectDialogContent = ({ title, buttonText, darkMode, onButtonClick, onDismiss }) => {\n    const theme = darkMode ? 'dark' : 'light';\n    return ((0, preact_1.h)(Snackbar_1.SnackbarContainer, { darkMode: darkMode },\n        (0, preact_1.h)(\"div\", { class: \"-cbwsdk-redirect-dialog\" },\n            (0, preact_1.h)(\"style\", null, RedirectDialog_css_1.default),\n            (0, preact_1.h)(\"div\", { class: \"-cbwsdk-redirect-dialog-backdrop\", onClick: onDismiss }),\n            (0, preact_1.h)(\"div\", { class: (0, clsx_1.default)('-cbwsdk-redirect-dialog-box', theme) },\n                (0, preact_1.h)(\"p\", null, title),\n                (0, preact_1.h)(\"button\", { onClick: onButtonClick }, buttonText)))));\n};\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/RedirectDialog/RedirectDialog.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/Snackbar/Snackbar-css.js":
/*!***********************************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/Snackbar/Snackbar-css.js ***!
  \***********************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\n// Copyright (c) 2018-2023 Coinbase, Inc. <https://www.coinbase.com/>\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.injectCssReset = void 0;\nconst cssReset_css_1 = __importDefault(__webpack_require__(/*! ./cssReset-css */ \"./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/cssReset/cssReset-css.js\"));\nfunction injectCssReset() {\n    const styleEl = document.createElement('style');\n    styleEl.type = 'text/css';\n    styleEl.appendChild(document.createTextNode(cssReset_css_1.default));\n    document.documentElement.appendChild(styleEl);\n}\nexports.injectCssReset = injectCssReset;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/cssReset/cssReset.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/util.js":
/*!******************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/sign/walletlink/relay/ui/components/util.js ***!
  \******************************************************************************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\n// Copyright (c) 2018-2024 Coinbase, Inc. <https://www.coinbase.com/>\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.ScopedLocalStorage = void 0;\nclass ScopedLocalStorage {\n    constructor(scope, module) {\n        this.scope = scope;\n        this.module = module;\n    }\n    setItem(key, value) {\n        localStorage.setItem(this.scopedKey(key), value);\n    }\n    getItem(key) {\n        return localStorage.getItem(this.scopedKey(key));\n    }\n    removeItem(key) {\n        localStorage.removeItem(this.scopedKey(key));\n    }\n    clear() {\n        const prefix = this.scopedKey('');\n        const keysToRemove = [];\n        for (let i = 0; i < localStorage.length; i++) {\n            const key = localStorage.key(i);\n            if (typeof key === 'string' && key.startsWith(prefix)) {\n                keysToRemove.push(key);\n            }\n        }\n        keysToRemove.forEach((key) => localStorage.removeItem(key));\n    }\n    scopedKey(key) {\n        return `-${this.scope}${this.module ? `:${this.module}` : ''}:${key}`;\n    }\n    static clearAll() {\n        new ScopedLocalStorage('CBWSDK').clear();\n        new ScopedLocalStorage('walletlink').clear();\n    }\n}\nexports.ScopedLocalStorage = ScopedLocalStorage;\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/util/ScopedLocalStorage.js?");

/***/ }),

/***/ "./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/util/cipher.js":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/util/cipher.js ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.LIB_VERSION = void 0;\nexports.LIB_VERSION = '4.0.2';\n\n\n//# sourceURL=webpack://art-interface-v1/./node_modules/.pnpm/@coinbase+wallet-sdk@4.0.2/node_modules/@coinbase/wallet-sdk/dist/version.js?");
